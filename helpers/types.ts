...
export type iOperaPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  | 'WFTM'
  | 'SFTM'
  | 'FUSD'
...
export type iOperaTestPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  | 'WFTM'
  | 'SFTM'
  | 'FUSD'
...
export interface iParamsPerNetwork<T> {
  ...
  [eEthereumNetwork.opera]: T;
  [eEthereumNetwork.operaTest]: T;
}
...
export interface IOperaConfiguration extends ICommonConfiguration {
  ReservesConfig: iOperaPoolAssets<IReserveParams>;
}

export interface IOperaTestConfiguration extends ICommonConfiguration {
  ReservesConfig: iOperaTestPoolAssets<IReserveParams>;
}
...
export type PoolConfiguration = ICommonConfiguration | IAaveConfiguration | IOperaConfiguration | IOperaTestConfiguration;
