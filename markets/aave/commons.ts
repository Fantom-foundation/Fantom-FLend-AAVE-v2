...
const MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  ...
  WFTM: oneEther.multipliedBy('0.00369068412860').toFixed(),
  SFTM: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FETH: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FBTC: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FUSD: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FBAND: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FBNB: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FCHF: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FCNY: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FGBP: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FGOLD: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FJPY: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FKRW: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FLINK: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FSILVER: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FWTIOIL: oneEther.multipliedBy('0.00369068412860').toFixed(),
  FEUR: oneEther.multipliedBy('0.00369068412860').toFixed(),
};
// ----------------
...
export const CommonsConfig: ICommonConfiguration = {
  ...
  PoolAdmin: {
    ...
    [eEthereumNetwork.opera]: undefined,
    [eEthereumNetwork.operaTest]: undefined,
  },
  PoolAdminIndex: 0,
  EmergencyAdmin: {
    [eEthereumNetwork.hardhat]: undefined,
  ...
  ProviderRegistry: {
    ...
    [eEthereumNetwork.opera]: ZERO_ADDRESS, // should be deployed automatically or can be deployed thru remix
    [eEthereumNetwork.operaTest]: ZERO_ADDRESS,
  },
  ProviderRegistryOwner: {
    ...
    [eEthereumNetwork.opera]: '0xde0D97d8e5b973101ec6B58388A331966EbB020b', // local
    [eEthereumNetwork.operaTest]: '0x0d98fa1992d9fe09f3bDF28B24A0cAfac2D81795', // testnet
  },
  LendingRateOracle: {
    [eEthereumNetwork.coverage]: '',
    [eEthereumNetwork.hardhat]: '',
    ...
    //[eEthereumNetwork.opera]: '0xE7897C508F407D422441714Ad534dCe1fF2EF08f', // manual deploy remix local
    //[eEthereumNetwork.opera]: '0xEc8044051a1BdeA2169c9655Fb5A47C9d82B888c', // manual deploy remix testnet
    [EthereumNetwork.opera]: ZERO_ADDRESS, //if zero address, then it will be deployed
    [EthereumNetwork.operaTest]: ZERO_ADDRESS, //if zero address, then it will be deployed
  },
  TokenDistributor: {
    [eEthereumNetwork.coverage]: '',
    [eEthereumNetwork.buidlerevm]: '',
    ...
    [eEthereumNetwork.opera]: ZERO_ADDRESS,
    [eEthereumNetwork.operaTest]: ZERO_ADDRESS,
  },
  AaveOracle: {
    [eEthereumNetwork.coverage]: '',
    ...
    //[EthereumNetwork.opera]: '0x88BD7caB8CcA53635c5a08b256CC7F4924cC513A',  // manual deploy remix Price Oracle Mock
    [EthereumNetwork.opera]: ZERO_ADDRESS, //if zero address, then it will be deployed
    [EthereumNetwork.operaTest]: ZERO_ADDRESS, //if zero address, then it will be deployed
  },
  FallbackOracle: {
    ...
    [EthereumNetwork.opera]: '0x8173B69510bA3fDE9Dc945FB11F17c24042f63F4', // Using same price oracle as for fMINT
    [EthereumNetwork.operaTest]: '0x1e6842469e8d9f613d36389fd518f65274e05189', // Using same price oracle as for fMINT
  },
  ChainlinkAggregator: {
    [eEthereumNetwork.coverage]: {},
    [eEthereumNetwork.hardhat]: {},
    ...
    // no chainlink agregator needed, using proxy thru fallback oracle which is the price proxy for fMINT
    [EthereumNetwork.opera]: {
      ...
      FKRW: ZERO_ADDRESS,
      FLINK: ZERO_ADDRESS,
      FSILVER: ZERO_ADDRESS,
      FWTIOIL: ZERO_ADDRESS,
      FEUR: ZERO_ADDRESS,
    },
    // no chainlink agregator needed, using proxy thru fallback oracle which is the price proxy for fMINT
  ...
  ATokenDomainSeparator: {
    ...
    [eEthereumNetwork.opera]: '',
    [eEthereumNetwork.operaTest]: '',
  },
  WETH: {
    ...
    [eEthereumNetwork.opera]: '0xAd84341756Bf337f5a0164515b1f6F993D194E1f', // to FUSD for opera
    [eEthereumNetwork.operaTest]: '0x91ea991bd52EE3C40EdA2509701d905e1Ee54074', // to FUSD for opera
  },
  ReserveFactorTreasuryAddress: {
    ...
    [eEthereumNetwork.opera]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
    [eEthereumNetwork.operaTest]: '0x464c71f6c2f760dda6093dcb91c24c39e5d6e18c',
  },
};
